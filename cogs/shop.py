...
from database import (
    get_user_drop_tickets, get_user_dust, get_user_gems,
    get_user_grab_tickets, get_user_premium_until, is_user_premium,
)
from cogs.views.shop import BuyConfirmView, ShopView
