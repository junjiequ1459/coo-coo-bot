...
async def _mock_fetch(s, u):
    # Test with pure raw illustration file (Dan Heng / Imbibitor Lunae)
    p = "/Users/user/Desktop/coo-coo-bot/test_lc_il.webp"
    if os.path.exists(p):
...
async def main():
    ...
    # Single Mythic Card Preview with Raw Artwork
    single_mythic = {
